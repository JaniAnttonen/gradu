...
\end{figure}
% TODO: Add a drawed image overarching the whole protocol, not just the distance bounding part
...
% TODO: Specify the setup (and the protocol for that matter) in a more specific manner, like hashing to prime etc
\subsection{Setup}
...
% TODO: Shuffling peer connections? \subsection{Using in Conjunction with Kademlia} (Makes it highly improbable to encounter a malicious peer with eclipsing intent, which provides a better entry to the network)
