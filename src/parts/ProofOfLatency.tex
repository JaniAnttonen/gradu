...
\lstinputlisting[language=Rust, float, frame=lines, breaklines=true, caption=VDF iteration logic]{./parts/code/vdfiteration.rs}[H]
...
\lstinputlisting[language=Rust, float, frame=lines, breaklines=true, caption=VDF proof generation]{./parts/code/proofgeneration.rs}[H]

The following is a code example of the verification of a VDF proof:
\lstinputlisting[language=Rust, float, frame=lines, breaklines=true, caption=VDF proof verification]{./parts/code/verifyvdf.rs}[H]
