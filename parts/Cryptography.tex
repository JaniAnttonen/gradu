...
\begin{enumerate}
  ...
  \item \(Third parties see the commitment, meaning that the committer cannot change the message m and convince the third parties with another input, locking its decision without revealing m.\)
...
\subsubsubject{Formal Definition}
