...
The code is structured as follows: A runnable binary demo (main.rs) and the reusable library (lib.rs) resides in the top crate. They both depend on the subcrates "P2P" and "vdf".
