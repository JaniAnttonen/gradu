...
To achieve a better algorithm design, the protocol itself is described as a state machine. Variable names have been converted into more readable non-mathematical forms.
