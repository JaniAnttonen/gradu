...
\lstinputlisting[language=text, float, frame=lines, breaklines=true, caption=Example output of Proof of Latency run]{./parts/code/samplerun.txt}
...
\lstinputlisting[language=Rust, float, frame=lines, fontsize=\footnotesize, breaklines=true, caption=VDF iteration logic]{./parts/code/vdfiteration.rs}
